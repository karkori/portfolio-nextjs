...
export const SITE_CONFIG = {
  ...
  // URLs y rutas
  url: process.env.NEXT_PUBLIC_SITE_URL || "https://mostapha.dev",
...
export const FEATURED_PROJECTS = [
  ...
  },
  {
    ...
    description: "Aplicación de gestión de tareas con funcionalidades de colaboración, recordatorios y seguimiento de progreso.",
